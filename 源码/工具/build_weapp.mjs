...
copyFileSync(here('../../assets/neon-stalkers-cute-mouths-v7.webp'), `${OUT_IMAGE_DIR}/neon-stalkers-cute-mouths-v7.webp`);
console.log(`已生成 微信小游戏版/js/core.js（${(out.length/1024).toFixed(0)} KB，${body.split('\n').length} 行逻辑）`);
console.log('已同步 微信小游戏版/images/neon-stalkers-cute-mouths-v7.webp（与网页版同一套截图校色、可爱小嘴异形追猎怪）');
