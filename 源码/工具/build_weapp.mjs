...
// 所以核心逻辑永远从 neon_maze_fragment.html 机械提取，js/shim.js 负责把它缺的
...
copyFileSync(here('../../assets/neon-stalkers-tracking-eyes-v9.webp'), `${OUT_IMAGE_DIR}/neon-stalkers-tracking-eyes-v9.webp`);
console.log(`已生成 微信小游戏版/js/core.js（${(out.length/1024).toFixed(0)} KB，${body.split('\n').length} 行逻辑）`);
console.log('已同步 微信小游戏版/images/neon-stalkers-tracking-eyes-v9.webp（与网页版共用圆润怪物留白眼球，黑瞳孔由 Canvas 动态绘制）');
