...
copyFileSync(here('../../assets/neon-stalkers-organic-v3.webp'), `${OUT_IMAGE_DIR}/neon-stalkers-organic-v3.webp`);
console.log(`已生成 微信小游戏版/js/core.js（${(out.length/1024).toFixed(0)} KB，${body.split('\n').length} 行逻辑）`);
console.log('已同步 微信小游戏版/images/neon-stalkers-organic-v3.webp（与网页版同一套异形追猎怪）');
