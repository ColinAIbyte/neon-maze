...
const webAtlasUrl = new URL('../../assets/neon-demons-pixel-v2.webp', import.meta.url);
if (!existsSync(weappAtlasUrl)) {
  fail.push('微信小游戏缺少 images/neon-demons-pixel-v2.webp，请运行 build_weapp.mjs');
