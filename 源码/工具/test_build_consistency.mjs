...
const weappAtlasUrl = new URL('../微信小游戏版/images/neon-stalkers-organic-v3.webp', import.meta.url);
const assets = [
  'doudou-hero.webp',
  'neon-logo-v2.webp',
  'neon-space-bg-v2.webp',
  'neon-stalkers-organic-v3.webp',
];
const assetSizeCaps = {
  'doudou-hero.webp': 30_000,
  'neon-logo-v2.webp': 30_000,
  'neon-space-bg-v2.webp': 40_000,
  'neon-stalkers-organic-v3.webp': 20_000,
};
const expectedDimensions = {
  'doudou-hero.webp': [512, 512],
  'neon-logo-v2.webp': [380, 380],
  'neon-space-bg-v2.webp': [1672, 941],
  'neon-stalkers-organic-v3.webp': [256, 256],
};
...
const webAtlasUrl = new URL('../../assets/neon-stalkers-organic-v3.webp', import.meta.url);
if (!existsSync(weappAtlasUrl)) {
  fail.push('微信小游戏缺少 images/neon-stalkers-organic-v3.webp，请运行 build_weapp.mjs');
