...
const weappAtlasUrl = new URL('../微信小游戏版/images/neon-demons-v1.webp', import.meta.url);
const assets = [
  'doudou-hero.webp',
  'neon-logo-v2.webp',
...
const webAtlasUrl = new URL('../../assets/neon-demons-v1.webp', import.meta.url);
if (!existsSync(weappAtlasUrl)) {
  fail.push('微信小游戏缺少 images/neon-demons-v1.webp，请运行 build_weapp.mjs');
