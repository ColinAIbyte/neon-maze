...
if (!src.includes("assets/neon-stalkers-cute-mouths-v7.webp") || !/const\s+sw=aw\/2,sh=ah\/2/.test(sprite))
  fail.push('四只截图校色、可爱小嘴异形大眼追猎怪的 2×2 图集没有接入');
...
if (!/wx\.createImage\(\)/.test(src) || !/images\/neon-stalkers-cute-mouths-v7\.webp/.test(src))
