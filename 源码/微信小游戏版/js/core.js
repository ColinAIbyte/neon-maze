 ...
 * 源码指纹: d1ea1cb2920b   （只跟 pacman_fragment.html 的内容走）
 */
...
if (makeCharacterImage){
  ...
  characterAtlas.src = IS_WECHAT_MINIGAME
    ? 'images/neon-stalkers-organic-v3.webp'
    : 'assets/neon-stalkers-organic-v3.webp';
}
...
function drawCharacterSprite(id,size,visualMode='normal'){
  ...
  ctx.save();
  /* organic-v3 是透明底的硬边像素图。关掉平滑，30px 时异形眼睛、瞳孔和面罩才不会
